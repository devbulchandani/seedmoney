...
export const IntegrationCarousel = ({
  ...
  buttonHref = "#",
  title = "Powered by a modern academic tech stack.",
  subtitle = "Built with React, Vite, TypeScript, TailwindCSS, Node.js, Express, MongoDB, and Piston API for real-time code execution.",
