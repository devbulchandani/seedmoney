...
const stats: StatItem[] = [
  {
    value: "50+",
    description: "Subjects across\nmultiple courses",
    delay: 0,
  },
  {
    value: "200+",
    description: "Practicals with\nfull IDE support",
    delay: 0.2,
  },
  {
    value: "4",
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Everything students need to excel academically{" "}
              <span
              ...
              >
                from practicals and notes to interview prep and viva questions.
              </span>
            </h2>
            ...
            >
              A modern university academic platform with a full-screen IDE, MCQ system, and curated study resources — all designed for students preparing for exams, practicals, and placements.
            </p>
