...
const defaultSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Viva Questions", href: "#viva" },
      { label: "PYQ Questions", href: "#pyq" },
      { label: "Study Notes", href: "#study-notes" },
      { label: "Solution Hints", href: "#hints" },
    ],
  },
  {
    title: "Legal",
...
export const Footer = ({
  companyName = "Virtual Lab",
  tagline = "The Academic Platform for University Students",
  sections = defaultSections,
  socialLinks = {
    twitter: "https://twitter.com",
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    email: "hello@virtuallab.dev",
  },
  copyrightText,
}: FooterProps) => {
